...
import { STATUS_EMPRESTIMOS } from "../../../appConfig";
...
function FormEmprestimo(): JSX.Element {
    ...
    useEffect(() => {
        ...
        fetchAlunos();
        fetchLivros();
        setStatusEmprestimo(Object.values(STATUS_EMPRESTIMOS));
    }, []);
    ...
    const handleSubmit = async (formData: {
        idAluno: number, idLivro: number, dataEmprestimo: string, dataDevolucao: string, statusEmprestimo: string
    }) => {
        if (new Date(formData.dataEmprestimo) > new Date(formData.dataDevolucao)) {
